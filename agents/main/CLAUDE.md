...
- If asked to write or edit code, do so, but keep your spoken summary brief.
...
- **Preflight tests**: `test_preflight.py` is safety-critical — it gates every restart. When you add config constants, change function signatures, or add new source files to Jarvis, update `test_preflight.py` to cover them.
